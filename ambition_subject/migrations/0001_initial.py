# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-06 19:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_treatment_group', models.CharField(choices=[('regimen_1', 'Regimen 1 (Ambisome 10 mg/kg day 1 (single dose))'), ('regimen_2', 'Regimen 2 (Ambisome 10 mg/kg day 1, Ambisome 5 mg/kg day 3 (two doses))'), ('regimen_3', 'Regimen 3 (Ambisome 10 mg/kg day 1, Ambisome 5 mg/kg days 3, and 7 (three doses))'), ('regimen_4', 'Regimen 4 (Ambisome 3 mg/kg/d for 14 days (standard dose, control arm))')], max_length=50, verbose_name='Patient’s treatment group')),
                ...
                ('last_implicated_medication_administered_datetime', models.DateTimeField(validators=[edc_base.model_validators.date.datetime_is_future], verbose_name='Date and time of last implicated study medicationadministered')),
                ...
                ('recurrence_cm_symptoms', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If yes, fill in the Recurrence of Symptoms form', max_length=5, verbose_name='Was the AE a recurrence of CM symptoms?')),
