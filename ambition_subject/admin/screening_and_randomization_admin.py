...
@admin.register(ScreeningRandomization, site=ambition_subject_admin)
class ScreeningRandomizationAdmin(ModelAdminMixin, admin.ModelAdmin):

    form = ScreeningRandomizationForm
