...
class PkDkCrfAdmin(CrfModelAdminMixin, admin.ModelAdmin):
    ...
    radio_fields = {
        ...
        'actual_flucytosine_dose_missed': admin.VERTICAL,
    ...
    fieldsets = (
        (None, {
            'fields': (
                ...
                'flucytosine_dose',
                'flucytosine_dose_one_swallowed_time',
                'flucytosine_dose_two_swallowed_time',
                'flucytosine_dose_three_swallowed_time',
                'flucytosine_dose_four_swallowed_time',
                'flucytosine_days_missed',
                'actual_fluconazole_dose_missed',
                'actual_flucytosine_dose_missed',
                ...
                'reason_missed_blood_sample_day_one',
                'time_blood_sample_one_taken_day_seven',
                'time_blood_sample_two_taken_day_seven',
                'time_blood_sample_three_taken_day_seven',
                'time_blood_sample_four_taken_day_seven',
                'time_blood_sample_five_taken_day_seven',
                'time_blood_sample_six_taken_day_seven',
